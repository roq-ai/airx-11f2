...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Airport Administrator'];
  const customerRoles: string[] = ['Passenger'];
  const tenantRoles: string[] = ['Airport Administrator', 'Ground Crew Member'];
  const addOns: string[] = [];
  const applicationName = `AirX`;
